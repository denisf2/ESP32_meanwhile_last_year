...
extern const uint8_t favicon_ico_gz_start[] asm("_binary_www_favicon_ico_gz_start");
extern const uint8_t favicon_ico_gz_end[] asm("_binary_www_favicon_ico_gz_end");
